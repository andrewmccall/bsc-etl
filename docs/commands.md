...
```bash
> ethereumetl get_block_range_for_date --provider-uri=https://bsc-dataseed1.binance.org/v3/7aef3f0cd1f64408b163814b22cc643c --date 2018-01-01
4832686,4838611
```
...
> ethereumetl stream --provider-uri https://bsc-dataseed1.binance.org/v3/7aef3f0cd1f64408b163814b22cc643c --start-block 500000
```
